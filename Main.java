...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            // Create a knowledge base and add clauses to it
            ...
            if (method.equals("TT")) {
                ...
                boolean entails = InferenceEngine.forwardChaining(kb, queryLiteral);
                if (entails) {
                    System.out.println("YES");
                } else {
                    System.out.println("NO");
                ...
                boolean entails = InferenceEngine.backwardChaining(kb, queryLiteral);
                if (entails) {
                    System.out.println("YES");
                } else {
                    System.out.println("NO");
